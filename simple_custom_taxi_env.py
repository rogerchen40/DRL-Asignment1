...
class SimpleTaxiEnv(gym.Wrapper):
    ...
    def reset(self, **kwargs):
        ...
        return (taxi_row, taxi_col, *self.passenger_loc, destination_x, destination_y,
                obstacle_north, obstacle_south, obstacle_east, obstacle_west), info
    ...
    def step(self, action):
        ...
        state = (taxi_row, taxi_col, self.passenger_loc[0], self.passenger_loc[1], destination_x, destination_y,
                 obstacle_north, obstacle_south, obstacle_east, obstacle_west)

        return state, reward, terminated, truncated, info

    def render_env(self, taxi_pos, passenger_pos, destination_pos, action=None, step=None, fuel=None):
...
def run_agent(agent_file, env_config, render=False):
    ...
    while not done:
        taxi_row, taxi_col, passenger_x, passenger_y, destination_x, destination_y, obstacle_north, obstacle_south, obstacle_east, obstacle_west = obs
        ...
        if render:
            env.render_env((obs[0], obs[1]), (obs[2], obs[3]), (obs[4], obs[5]),
